...
#$ns duplex-link-op $n5 $n2 orient right-down
...
$ns at 5 "finish"
$ns run
#$ns at 7.5 "$ns detach-agent $n2 $tcp ; $ns detach-agent $n5 $sink"
#$ns at 16.0 "$ns detach-agent $n1 $tcp1 ; $ns detach-agent $n4 $sink"
$ns at 16.5 "finish"
$ns run
